...
class InvoiceGenerator:
    def __init__(self):
        pass  # Removed auto-incrementing counter
    ...
    def generate_pdf(self, invoice_data, filename=None):
        ...
        invoice_details_data = [
            [
                ...
                Paragraph(f"<b>Invoice #</b><br/>{invoice_data['invoice_number']}", normal_style)
            ]
        ]
    ...
    <div class="container">
        ...
        <div class="info-box">
            ...
            <ul>
                ...
                <li>✅ Manual invoice number input</li>
            </ul>
        </div>
        ...
        <form method="POST" action="/generate_invoice">
            <div class="form-group">
                ...
                <input type="text" id="invoice_number" name="invoice_number" placeholder="e.g., 312" required>
            </div>
...
def api_generate_invoice():
    ...
    try:
        ...
        # Validate required fields
        required_fields = ['invoice_number', 'delivery_date', 'vehicle_number', 'quantity', 'unit_price']
